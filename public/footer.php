...
<div class="bg-light d-lg-none d-flex justify-content-evenly align-items-center" style="background: black; height:80px;position:fixed;bottom:0;width:100%">
...
<footer class="d-none d-lg-block " style="bottom: 0;width:100%;border-top:1px solid gray; height:150px;background-color:black;">
