...
<body style="background-color:#E5E5E5">
    <div class="container-fluid p-0">
        ...
        <div class="p-3 d-flex justify-content-between align-items-center" style="width:100%;background-color: #E5E5E5; height:80px;">
        ...
        <div class="p-5 d-flex flex-column align-items-center" >
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="d-flex justify-content-center align-items-center" style="width:100%;height:120px;background: #FFFFFF;box-shadow: 0px 30px 60px rgba(57, 57, 57, 0.1);border-radius: 30px;">
                ...
                <div class="mt-5">
                    ...
                    <input type="text" name="type" placeholder="Type" style="border:0;border-bottom:1px solid black;background-color:#E5E5E5;">
                </div>
                <div class="mt-3">
                    <i class="fas fa-file-signature" style="width:10px;font-size: 20px; color: gray;margin-right:15px"></i>
                    <input type="text" name="name" placeholder="Name" style="border:0;border-bottom:1px solid black;background-color:#E5E5E5;">
                </div>
                <div class="mt-3">
                    <i class="fas fa-pizza-slice" style="width:10px;font-size: 20px; color: gray;margin-right:15px"></i>
                    <input type="text" name="description" placeholder="Description" style="border:0;border-bottom:1px solid black;background-color:#E5E5E5;">
                </div>
                <div class="mt-3">
                    <i class="fas fa-map-pin" style="width:10px;font-size: 20px; color: gray;margin-right:15px"></i>
                    <input type="text" name="address" placeholder="Address" style="border:0;border-bottom:1px solid black;background-color:#E5E5E5;">
                </div>
        ...
        <div class="d-flex justify-content-evenly align-items-center" style="width:100%;position:fixed;bottom:0%;background-color: lightgray; height:80px;">
